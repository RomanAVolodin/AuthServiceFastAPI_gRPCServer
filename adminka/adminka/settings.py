...
SECRET_KEY = 'django-insecure-^z+xp+e2f6x+x%4mz!$ho(@wgnx9nzn2o7yx-t(rfsc=2b$+#g'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('POSTGRES_ADMIN_HOST'),
...
AUTH_API_LOCAL_LOGIN_URL = os.getenv('AUTH_API_LOCAL_LOGIN_URL')
